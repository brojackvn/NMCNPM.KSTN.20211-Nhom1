...
public class FormDanhMucHoKhau extends javax.swing.JPanel {
    ...
    private void ButtonTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonTimKiemActionPerformed
        try {
            ...
            String para1 = "Danh mục hộ khẩu: ";
            Paragraph paragraph1 = new Paragraph(para1).setFont(font);
            document.add(paragraph1);


            Table table = new Table(new float[]{100F, 100F, 300F});

            Cell cell1 = new Cell();
            cell1.add(new Paragraph("Tên chủ hộ").setFont(font));
            table.addCell(cell1);

            Cell cell2 = new Cell();
            cell2.add(new Paragraph("Ngày đăng kí").setFont(font));
            table.addCell(cell2);

            Cell cell3 = new Cell();
            cell3.add(new Paragraph("Địa chỉ").setFont(font));
            table.addCell(cell3);
